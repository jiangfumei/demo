package com.jfmlc.demo.generator;

import cn.hutool.core.util.StrUtil;
import com.jfmlc.demo.generator.bean.EntityOfEntity;
...
public class BootGenerator {
     ...
     * 建议仅需修改
     */
    private static final String author = "fumei";
     ...
     * (文件自动生成至该包下)
     */
    private static final String domainPackage = "com.jfmlc.demo.modules.base.domain";

    /**
     * dao对应包
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "com.jfmlc.demo.modules.base.dao";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "com.jfmlc.demo.modules.base.service";
     ...
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "com.jfmlc.demo.modules.base.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
        String root = System.getProperty("user.dir")+"/src/main/java/com/jfmlc/demo/generator/template";
    ...
    private static void generateCode(GroupTemplate gt) throws IOException{
        ...
        //创建文件
        String entityFileUrl = System.getProperty("user.dir")+"/src/main/java/"+ dotToLine(domainPackage) + "/" + className + ".java";
